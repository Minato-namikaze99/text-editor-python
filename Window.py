...
class Window:
    def __init__(self):
        ...
        self.isFileOpen = True # Variable to check whether the file has been opened or not
        self.File = "" # Stores teh location of the file
        self.isFileChange = False # Variable to check whether the file has been changed or not
        self.elecnt = 0 
        self.mode = "normal" # Variable to store the view mode of the application
        ...
        # Initialisation Of Stack Objects By Original state i.e if the file contains data, it is the Original state of that file
        self.UStack = Stack(self.TextBox.get("1.0", "end-1c"))
        self.RStack = Stack(self.TextBox.get("1.0", "end-1c"))

    # New File method which creates a new file
    def new_file(self):
    ...
    # Open a file which opens a file in editing mode
    def open_file(self):
        self.TextBox.config(state=NORMAL)
    ...
    # Save new file -> this function is for saving the new file
    ...
    # Getting the data from file and showing in the text widget box
    ...
    # This function invokes whenever a key is pressed whether it is a special-key or a normal key
    ...
    # Undo the data by calling Stack class functions
    def undo(self):
        self.isFileChange = True
    ...
    # Redo/Rewrite the task/data by calling Stack class functions
    def redo(self):
    ...
    # Close the window (called when the close button at the right-top is clicked)
    def on_closing(self):
        if self.isFileOpen and self.isFileChange:
            self.save_file(self.File)
        self._quit()

    # Quit or Exit Function to exit from Text-Editor
    def _quit(self):
        self.window.quit()
        self.window.destroy()

    # Dark mode view by changing the color of Text widget
